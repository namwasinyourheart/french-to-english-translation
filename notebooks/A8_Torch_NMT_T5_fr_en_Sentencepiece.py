...
# 구분자 변경
train_df.to_csv('ratings_train.txt', sep = '\t', index = False)
test_df.to_csv('ratings_test.txt', sep = '\t', index = False)
...
data = [json.loads(line) for line in open('ratings_train_t5.json', 'r')]
print(data[0])
